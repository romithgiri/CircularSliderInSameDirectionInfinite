...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var proTipsViewPagerAdapter: ViewPagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var proTipsDataArrayList = listOf(
        ...
        proTipsViewPagerAdapter = ViewPagerAdapter(proTipsDataArrayList)
        view_pager_scan.adapter = proTipsViewPagerAdapter
        val mViewPager : ViewPager2 = findViewById(R.id.view_pager_scan)
        val handler = Handler()
